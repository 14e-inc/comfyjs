...
# This is a script copied from a Claude Code Install .sh
# It can be further deconstructed to get a hold on certain artifacts which may not always be available.
